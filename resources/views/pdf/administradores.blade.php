            ...
            <td class="datos-grales-td">
                <table class="table_h_factura">
                    ...
                    <tr>
                        <td>
                            <p>
                                RUC: <span>BHUTMHTFP8</span>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p>TELEFONO: <span>0541 - 44404</span> </p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p>E-MAIL: <span>unvpolitecnica@unves.edu.com</span> </p>
                        </td>
                    </tr>
                     <tr>
                        <td>
    ...
    <table class="table_materiales">
        ...
        <tbody>
            @foreach ($administradores as $administradore)
                <tr>
                    <td>{{ $loop->index + 1 }}</td>
                    <td>{{ $administradore->persona->nombre }} {{ $administradore->persona->apellido }}</td>
                    <td>{{ $administradore->cargo }}</td>
                    <td>{{ $administradore->persona->ci_numero }}</td>
                    <td>{{ $administradore->user->email }}</td>
                    <td>{{ $administradore->persona->telefono }}</td>
                    <td>{{ $administradore->persona->ciudade->nombre }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
