        ...
        <div class="py-12 px-4 lg:px-8 max-w-7xl">
            ...
            <div class="mt-6 flex flex-col gap-6 lg:flex-row">
                ...
                <div class="flex gap-6 items-center lg:flex-col lg:items-start">
                    <div
                        class="w-36 h-32 p-2 bg-white shadow py-4 border rounded-xl text-sm relative cursor-pointer group">
                        <a
                    ...
                    <!-- opion persona page -->
                    <div
                        class="w-36 h-32 p-2 bg-white shadow py-4 border rounded-xl text-sm relative group">
                        <Link
                    ...
                    <!-- puntajes -->
                    <div
                        class="w-36 h-32 p-4 bg-white shadow py-4 border rounded-xl text-sm relative group">
                        <Link
                            :href="route('clases.acumulativos', clase.id)"
                            class="absolute top-0 left-0 right-0 bottom-0"
                            tabindex="-1">
                            <div
                                class="font-bold w-full text-center absolute top-1/2 -translate-y-1/2">
